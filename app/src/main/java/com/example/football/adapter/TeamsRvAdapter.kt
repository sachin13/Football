...
import com.example.football.databinding.ItemTeamsRvBinding
import com.example.football.models.responce.standins.Standing
...
class TeamsRvAdapter : ListAdapter<Standing, TeamsRvAdapter.MyViewHolder>(MyDiffUtill()) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        return MyViewHolder(ItemTeamsRvBinding.inflate(
